...
enum MATH_ERROR {
  ...
  MATH_ERROR_INVARID_FDEF = (MATH_ERROR_TYPE_SYNTAX | 0x0009),
  MATH_ERROR_UNEXP_TOKEN  = (MATH_ERROR_TYPE_SYNTAX | 0x000A),

  MATH_ERROR_INVALID_PRM  = (MATH_ERROR_TYPE_PARSE  | 0x0010),
  MATH_ERROR_CONST_EXIST  = (MATH_ERROR_TYPE_PARSE  | 0x0020),
