...
static struct funcs FileFunc[] = {
  ...
  {"DRAW_POLYLINE",  {G_N_ELEMENTS(draw_polyline_arg_type), 1, MATH_FUNCTION_TYPE_NORMAL, file_draw_polyline, draw_polyline_arg_type, NULL, NULL, NULL}},
  {"DRAW_POLYGON",   {G_N_ELEMENTS(draw_polygon_arg_type),  1, MATH_FUNCTION_TYPE_NORMAL, file_draw_polygon, draw_polygon_arg_type, NULL, NULL, NULL}},
  {"DRAW_TEXT",      {G_N_ELEMENTS(draw_text_arg_type),     1, MATH_FUNCTION_TYPE_NORMAL, file_draw_text, draw_text_arg_type, NULL, NULL, NULL}},
  {"DRAW_TEXT_RAW",  {G_N_ELEMENTS(draw_text_arg_type) - 1, 1, MATH_FUNCTION_TYPE_NORMAL, file_draw_text_raw, draw_text_arg_type, NULL, NULL, NULL}},
  ...
  {"TEXT_OBJ_SET",   {G_N_ELEMENTS(text_obj_set_arg_type),  1, MATH_FUNCTION_TYPE_NORMAL, file_text_obj_set, text_obj_set_arg_type, NULL, NULL, NULL}},
