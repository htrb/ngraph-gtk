/* 
 * $Id: x11dialg.h,v 1.4 2008/06/05 06:22:40 hito Exp $
 * 
...
extern char *CbLineWidth[];
extern int CbLineWidthNum;
extern char *CbTextPt[];
extern int CbTextPtNum;
extern char *CbDirection[];
extern int CbDirectionNum;
extern char *CbMarkSize[];
extern int CbMarkSizeNum;
extern gint8 Dashes[];
extern int CbLineWidthNum;
...
GtkWidget *create_color_button(void);
...
struct MiscDialog
{
  ...
  GtkWidget *editor, *directory, *history, *path, *datafile,
    ...
    *hist_size, *info_size, *preserve_width;
};
...
struct ViewerDialog
{
  ...
  void (*CloseWindow) (GtkWidget *w, void *data);
  /****** local member *******/
  GtkWidget *dpi, *ruler, *redraw, *loadfile, *grid;
  struct objlist *Obj;
  int Id;
  int Clear;
  int dpis;
