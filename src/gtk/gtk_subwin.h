...
GtkWidget *label_sub_window_create(struct SubWin *d, const char *title, const char *icon, const char *icon2);
GtkWidget *text_sub_window_create(struct SubWin *d, const char *title, const char *icon, const char *icon2);
GtkWidget *list_sub_window_create(struct SubWin *d, const char *title, int lisu_num, n_list_store *list, const char *icon, const char *icon2);
GtkWidget *tree_sub_window_create(struct SubWin *d, const char *title, int page_num, int *lisu_num, n_list_store **list, GtkWidget **icons, const char *icon, const char *icon2);
