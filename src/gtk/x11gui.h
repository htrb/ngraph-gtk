...
void input_dialog(GtkWidget *parent, const char *title, const char *mes, const char *init_str, const char *button, struct narray *buttons, string_response_cb cb, gpointer user_data);
#else
...
#if GTK_CHECK_VERSION(4, 0, 0)
void ndialog_run(GtkWidget *dlg, GCallback cb, gpointer user_data);
#else
