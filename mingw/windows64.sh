...
BINFILES="libLerc.dll libatk-1.0-0.dll libbz2-1.dll libcairo-2.dll
          libcairo-gobject-2.dll libcairo-script-interpreter-2.dll
          libdatrie-1.dll libdeflate.dll libepoxy-0.dll libexpat-1.dll
          ...
          libpcre2-8-0.dll libpixman-1-0.dll libpng16-16.dll
          libreadline8.dll librsvg-2-2.dll libsharpyuv-0.dll
          libtermcap-0.dll libthai-0.dll libtiff-6.dll libwebp-7.dll
